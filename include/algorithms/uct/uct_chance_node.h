...
namespace mcts {
    ...
    /**
     * Implementation of UCT (chance nodes) in Mcts schema. 
     * 
     * Member variables:
     *      next_state_distr: 
     ...
     */
    class UctCNode : public MctsCNode {
        ...
        /**
         * Core MctsCNode implementation functions. Implement in .cpp and add any docstrings.
         */
        public: 
            /**
             * Constructor
