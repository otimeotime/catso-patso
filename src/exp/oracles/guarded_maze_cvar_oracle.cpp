...
namespace mcts::exp::oracles {
    ...
    GuardedMazeCvarOracle::StateKey GuardedMazeCvarOracle::make_key(
        std::shared_ptr<const mcts::Int4TupleState> state)
    {
        return state->state;
    }

    GuardedMazeCvarOracle::GuardedMazeCvarOracle(
    ...
    const OptimalDistributionSolution& GuardedMazeCvarOracle::solve_state(
        std::shared_ptr<const mcts::Int4TupleState> state)
    {
