...
namespace {
    ...
    static vector<Candidate> build_candidates(double cvar_tau) {
        ...
        cands.push_back({"CATSO", "n_atoms=100,optimism=8.0,p=1.0,tau=" + to_string(cvar_tau), [cvar_tau](auto env, auto init_state, int max_depth, int seed) {
        ...
        cands.push_back({"PATSO", "max_particles=100,optimism=8.0,p=1.0,tau=" + to_string(cvar_tau), [cvar_tau](auto env, auto init_state, int max_depth, int seed) {
